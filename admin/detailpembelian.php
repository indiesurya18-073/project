...
<div class="panel-headline">
    ...
    <?php
    $ambil = $db->query("SELECT * FROM pembelian JOIN user ON pembelian.id_user=user.id_user WHERE pembelian.id_pembelian='$_GET[id]'");
    ...
    <div class="panel-body">
        ...
        <table class="table table-striped mt-5">
            ...
            <tbody>
                <?php $nomor = 1; ?>
                <?php $totalbelanja = 0 ?>
                <?php $ambil2 = $db->query("SELECT * FROM pembelian_produk JOIN produk ON pembelian_produk.id_produk=produk.id_produk WHERE pembelian_produk.id_pembelian='$_GET[id]'") ?>
