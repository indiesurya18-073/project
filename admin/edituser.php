...
<?php if (isset($_POST["simpan"])) {
    $koneksi->query("UPDATE user SET name='$_POST[nama]',username='$_POST[username]',password='$_POST[password]',email='$_POST[email]',tlp_user='$_POST[tlp]',alamat_user='$_POST[alamat]' WHERE id_user='$_GET[id]'");
